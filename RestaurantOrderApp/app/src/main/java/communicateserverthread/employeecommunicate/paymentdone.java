...
public class paymentdone implements Runnable
{
    private employeetablepayment employeetablepayment;
    Socket soc;
    private int tableno;

    public paymentdone(employeetablepayment employeetablepayment, int tableno)
    {
